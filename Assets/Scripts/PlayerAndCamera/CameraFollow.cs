...
public class CameraFollow : MonoBehaviour
{
    ...
    private static readonly float MIN_CAMERA_X = -6f;
    private static readonly float MAX_CAMERA_X = 6f;
    ...
    void FixedUpdate()
    {
        ...
        if (Vector2.Distance(playerPos, this.transform.position) > CAMERA_FREEZE_RADIUS) {
            ...
            targetPos = Vector2.Lerp(this.transform.position, targetPos, 0.15f);
